...
Plot the first layer of the RasterBrick to see the image. Then manually draw a regular extent, 'e' which we will later use to crop gewata. 

```{r }
plot(gewata, 1, main = "Plot of gewata raster layer")
